...
- **Always Plan First**: Untuk setiap prompt atau permintaan baru dari pengguna, agen WAJIB membuat rencana implementasi (Implementation Plan / `implementation_plan.md`) terlebih dahulu sebelum melakukan perubahan kode atau menjalankan aksi eksekusi.
